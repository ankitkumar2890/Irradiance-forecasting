...
PRIMARY_STATION = STATIONS[0]  # Tirunelveli — primary for GHI (NREL)

# For Moirai fine-tuning, we use a single station's time series
FINETUNE_STATION = "tirunelveli"

# ---- Data years ----
YEARS = [2017, 2018, 2019]

# Temporal split across 3 years:
#   Train: Jan 2017 – Jun 2019  (~30 months)
#   Val:   Jul 2019 – Sep 2019  (~3 months)
#   Test:  Oct 2019 – Dec 2019  (~3 months)
TRAIN_END   = "2019-06-30 23:00"
VAL_START   = "2019-07-01 00:00"
VAL_END     = "2019-09-30 23:00"
TEST_START  = "2019-10-01 00:00"
