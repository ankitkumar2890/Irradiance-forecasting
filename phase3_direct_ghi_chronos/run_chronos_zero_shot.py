"""Zero-shot Amazon Chronos baseline for Phase 3 direct GHI forecasting.

This reuses the existing Phase 3 validation dataset from `phase3_direct_ghi`
and writes results in the usual validation-report format under this folder's
`results/` directory.
"""
...
from moirai.master_files.export_pdf import build_finetuned_pdf  # noqa: E402
from phase3_direct_ghi.config import (  # noqa: E402
    CLUSTER_NAME,
    GHI_SCALE_FACTOR,
    PREDICTION_LENGTH,
    STATIONS,
...
SOURCE_PHASE3_DIR = PROJECT_ROOT / "phase3_direct_ghi"
DATASET_DIR = SOURCE_PHASE3_DIR / "dataset"
MULTI_STATION_DOWNLOADS_DIR = SOURCE_PHASE3_DIR / "downloads" / "multi_station"
...
def evaluate_prediction_frame(df_pred: pd.DataFrame, ghi_filter_wm2: float, cluster_name: str):
    ...
    all_metrics = {
        "pipeline": "phase3_direct_ghi_chronos_zero_shot",
